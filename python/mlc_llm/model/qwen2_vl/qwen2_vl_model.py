...
from .qwen2_vl_image import Qwen2VisionModel
logger = logging.getLogger(__name__)


@dataclasses.dataclass
class QWen2VLConfig(ConfigBase):  # pylint: disable=too-many-instance-attributes
...
class QWen2VLModel(nn.Module):  # pylint: disable=too-many-instance-attributes
    def __init__(self, config: QWen2VLConfig):
