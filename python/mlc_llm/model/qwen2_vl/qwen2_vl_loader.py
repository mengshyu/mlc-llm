...
def huggingface(model_config: QWen2VLConfig, quantization: Quantization) -> ExternMapping:
    ...
    """
    model = QWen2VLModel(model_config)
    ...
    _add("visual.merger.mlp_0.bias", "visual.merger.mlp.0.bias")
    _add("visual.merger.mlp_0.weight", "visual.merger.mlp.0.weight")
    _add("visual.merger.mlp_2.bias", "visual.merger.mlp.2.bias")
    _add("visual.merger.mlp_2.weight", "visual.merger.mlp.2.weight")
